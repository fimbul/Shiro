...
#ifndef SHIRO_TUPLE_DETAIL_ALL_ASSIGNABLE_HPP
#define SHIRO_TUPLE_DETAIL_ALL_ASSIGNABLE_HPP
...
struct all_assignable {
 private:
  template <std::size_t... Indices>
  static logical_and_c<
      true, std::is_assignable<
...
#endif  // #ifndef SHIRO_TUPLE_DETAIL_ALL_ASSIGNABLE_HPP
